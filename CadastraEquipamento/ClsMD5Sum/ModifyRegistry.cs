...
namespace Utility.ModifyRegistry
{
    ...
    public class ModifyRegistry
    {
        ...
        private string subKey = "Software\\Setings";//+ Application.ProductName.ToUpper(); // "SOFTWARE\\" + Application.ProductName.ToUpper();
        /// <summary>
        ...
        public string LerValor(string sChave, string sDefault)
        {
            string sRet = sDefault;
            string sVar = Read(sChave);
            if (sVar == null)
                Write(sChave, sDefault);
            else
                sRet = sVar;
            return sRet;
        }
